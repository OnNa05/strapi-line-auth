...
module.exports = ({ strapi }) => ({
  ...
  /**
   * Promise to fetch authenticated user by id.
   * @return {Promise}
   */
  ...
  /**
   * Promise to fetch authenticated user by line user ID.
   * @return {Promise}
   */
  fetchAuthenticatedUserByLineUserID(userId) {
    return strapi
      .query("plugin::users-permissions.user")
      .findOne({ where: { userId, provider : "line" }, populate: ["role"] });
  },
